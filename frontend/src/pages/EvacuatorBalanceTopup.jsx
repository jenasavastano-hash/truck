...
export default function EvacuatorBalanceTopup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const { data } = await api.post('/evacuator/balance/topup', { amount: num });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-slate-50">
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        >
          <div className="bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 text-white px-6 py-6">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  max="100000"
                  step="100"
                  className="w-full pl-12 pr-4 py-3.5 border-2 border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition text-lg font-semibold"
                  placeholder="Сумма"
                />
              </div>
            ...
            <Card className="p-5 bg-gradient-to-br from-slate-50 to-orange-50/30">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <motion.button
                ...
                className="flex-1 py-3.5 px-4 rounded-xl font-semibold bg-gradient-to-r from-orange-500 to-amber-500 text-white hover:from-orange-600 hover:to-amber-600 transition shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
